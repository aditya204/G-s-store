...
public class MyOrderGrocery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_my_order_grocery );
        ...
        loadingDialog = new Dialog( MyOrderGrocery.this );
            ...
            public void setDAta(String Name, String res, String desc, final String Oid, final String Pid, String Rating, final String Review, String Otp) {
                ...
                constraintLayout.setOnClickListener( new View.OnClickListener( ) {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent( itemView.getContext( ), com.gaurishankarprashad.gsstore.GroceryOrderDetails.class );
